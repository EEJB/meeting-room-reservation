 ...
 * @author narag
 */
public class CheckInOutRecords extends javax.swing.JFrame {

    /**
     * Creates new form Dashboard_MeetingRoomReservation
     */
    public CheckInOutRecords() {
        initComponents();
        loadCheckInData();
        ...
        setImageToLabel(cio_icon, "src/Image/ACTIVE CHECK IN_OUT.png");
        ...
        setImageToLabel(headerr_icon, "src/Image/ACTIVE CHECK IN_OUT.png");
        
        // START NEW CODE HERE
        
        CustomTableStyler.applyStyle(chckin_chckout_rcrd_table);
        ...
        for (int i = 0; i < chckin_chckout_rcrd_table.getColumnCount(); i++) {
            chckin_chckout_rcrd_table.getColumnModel().getColumn(i).setCellRenderer(cellRenderer);
        }
...
public class CustomTableStyler {
    ...
    private void initComponents() {
        ...
        chckin_chckout_rcrd_table = new javax.swing.JTable();
        datePick = new com.toedter.calendar.JDateChooser();
        jButton1 = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("QCU RESERVATIONS | Check In & Out Records");
        ...
        cio_indicator.setBackground(new java.awt.Color(11, 42, 122));
        ...
        cio_label.setFont(new java.awt.Font("Roboto", 1, 16)); // NOI18N
        cio_label.setForeground(new java.awt.Color(11, 42, 122));
        ...
        jLabel3.setText("Check In & Check Out Record");
        ...
        db_mrco_mtng_rm.setText("Agenda:");
        ...
        Main_Panel.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 120, 1070, 180));
        Main_Panel.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 320, 1070, 20));

        jLabel1.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        jLabel1.setText("Date:");
        Main_Panel.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 340, -1, -1));

        db_mrco_remarks.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        db_mrco_remarks.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                db_mrco_remarksActionPerformed(evt);
            }
        });
        db_mrco_remarks.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                db_mrco_remarksKeyReleased(evt);
            }
        });
        Main_Panel.add(db_mrco_remarks, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 370, 580, 50));

        jLabel7.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        jLabel7.setText("Search:");
        Main_Panel.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 340, -1, -1));

        chckin_chckout_rcrd_table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "Check - In", "Check - Out", "Date", "Name of Student", "Agenda"
            }
        ) {
        ...
        chckin_chckout_rcrd_table.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                chckin_chckout_rcrd_tableMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(chckin_chckout_rcrd_table);
        if (chckin_chckout_rcrd_table.getColumnModel().getColumnCount() > 0) {
            chckin_chckout_rcrd_table.getColumnModel().getColumn(0).setResizable(false);
            chckin_chckout_rcrd_table.getColumnModel().getColumn(1).setResizable(false);
            chckin_chckout_rcrd_table.getColumnModel().getColumn(2).setResizable(false);
            chckin_chckout_rcrd_table.getColumnModel().getColumn(3).setResizable(false);
            chckin_chckout_rcrd_table.getColumnModel().getColumn(4).setResizable(false);
        }

        Main_Panel.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 450, 1060, 290));
        ...
        Main_Panel.add(datePick, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 370, 240, 50));
        ...
        Main_Panel.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1020, 370, 100, 50));
    ...
    private void CheckInOutPanelMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CheckInOutPanelMouseExited
        ...
        cio_label.setForeground(new Color(11,42,122));
    ...
    private void db_mrco_remarksActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_db_mrco_remarksActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_db_mrco_remarksActionPerformed

    private void db_mrco_remarksKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_db_mrco_remarksKeyReleased
        applyFilter();
    }//GEN-LAST:event_db_mrco_remarksKeyReleased

    private void datePickPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_datePickPropertyChange
        if ("date".equals(evt.getPropertyName())) {
            applyFilter(); // Reuse the same method
        }
    }//GEN-LAST:event_datePickPropertyChange

    private void chckin_chckout_rcrd_tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_chckin_chckout_rcrd_tableMouseClicked
        if (evt.getClickCount() == 1) {
            int selectedRow = chckin_chckout_rcrd_table.getSelectedRow();
            if (selectedRow != -1) {
                String studentName = chckin_chckout_rcrd_table.getValueAt(selectedRow, 3).toString();
                String date = chckin_chckout_rcrd_table.getValueAt(selectedRow, 2).toString();
                showStudentDetails(studentName, date);
            }
        }
    }//GEN-LAST:event_chckin_chckout_rcrd_tableMouseClicked

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        datePick.setDate(null);

        db_mrco_remarks.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CheckInOutRecords.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CheckInOutRecords().setVisible(true);
            }
        });
    }
    ...
    public void loadCheckInData() {
        ...
        DefaultTableModel model = (DefaultTableModel) chckin_chckout_rcrd_table.getModel();
        model.setRowCount(0); // clear table

        String query = """
            SELECT 
                CONCAT(s.LastName, ', ', s.FirstName, ' ', s.MiddleName, ' ', ISNULL(s.Suffix, '')) AS FullName,
                sc.CheckInTimeIn,
                sc.CheckInTimeOut,
                sc.CheckInDate,
                sc.Agenda
            FROM StudentCheckIn sc
            JOIN STUDENT s ON sc.StudentNumber = s.StudentNumber
        """;
        ...
        try (PreparedStatement ps = conn.prepareStatement(query);
            ...
            while (rs.next()) {
                String timeIn = rs.getString("CheckInTimeIn");
                String timeOut = rs.getString("CheckInTimeOut");
                String date = rs.getString("CheckInDate");
                String name = rs.getString("FullName").trim();
                String agenda = rs.getString("Agenda");

                model.addRow(new Object[]{timeIn, timeOut, date, name, agenda});
            }
    ...
    public void filterCheckInData(java.util.Date selectedDate, String searchTerm) {
        Connection conn = dbConnection.dbCon.getConnection();
        DefaultTableModel model = (DefaultTableModel) chckin_chckout_rcrd_table.getModel();
        ...
        String query = """
            ...
            FROM StudentCheckIn sc
            JOIN STUDENT s ON sc.StudentNumber = s.StudentNumber
            WHERE ( ? IS NULL OR sc.CheckInDate = ? )
                AND (
                    CONCAT(s.FirstName, ' ', s.MiddleName, ' ', s.LastName, ' ', ISNULL(s.Suffix, '')) LIKE ?
                    OR sc.CheckInTimeIn LIKE ?
                    OR sc.CheckInTimeOut LIKE ?
                    OR sc.Agenda LIKE ?
                )
        """;
        ...
        try (PreparedStatement ps = conn.prepareStatement(query)) {
            ...
            ps.setDate(1, sqlDate); // first ?
            ps.setDate(2, sqlDate); // second ?

            String keyword = "%" + searchTerm.trim() + "%";
            ps.setString(3, keyword); // name
            ps.setString(4, keyword); // time in
            ps.setString(5, keyword); // time out
            ps.setString(6, keyword); // agenda
    ...
    private void applyFilter() {
        java.util.Date selectedDate = datePick.getDate(); // e.g. dateChooser
        String keyword = db_mrco_remarks.getText().trim();          // e.g. txtSearch
        filterCheckInData(selectedDate, keyword);
    }
    
    public void showStudentDetails(String fullName, String date) {
        Connection conn = dbConnection.dbCon.getConnection();
        ...
        String query = """
            ...
            JOIN STUDENT s ON sc.StudentNumber = s.StudentNumber
            WHERE 
                CONCAT(s.LastName, ', ', s.FirstName, ' ', s.MiddleName, ' ', ISNULL(s.Suffix, '')) = ?
                AND sc.CheckInDate = ?
        """;
        ...
        try (PreparedStatement ps = conn.prepareStatement(query)) {
            ...
            if (rs.next()) {
                db_mrco_chck_out_std_name.setText(rs.getString("FullName"));
                db_mrco_chck_out_std_no.setText(rs.getString("StudentNumber"));
                db_mrco_full_name.setText(rs.getString("ContactNumber"));
                db_mrco_eml_add.setText(rs.getString("Email"));
                db_mrco_prgrm.setText(rs.getString("CourseProgram"));
                db_mrco_chck_out_meeting_room.setText(rs.getString("Agenda"));
                db_mrco_chck_out_date.setText(rs.getString("CheckInDate"));
                String checkInTime = rs.getString("CheckInTimeIn");
                String checkOutTime = rs.getString("CheckInTimeOut");
                db_mrco_chck_out_reservation_code.setText("Check-In: " + checkInTime + " | Check-Out: " + checkOutTime);
            }
    ...
    private javax.swing.JTable chckin_chckout_rcrd_table;
