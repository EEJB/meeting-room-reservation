 ...
 * @author narag
 */
public class DailyRecord_ComputerAssignment extends javax.swing.JFrame {

    /**
     * Creates new form Dashboard_MeetingRoomReservation
     */
    public DailyRecord_ComputerAssignment() {
        initComponents();
        ...
        // START NEW CODE HERE
        CustomTableStyler.applyStyle(DailyRecord_CompAssgn_Table);
    }
...
public class CustomTableStyler {
    ...
    private void initComponents() {
        ...
        db_dr_ca_srch_bx = new RoundedTextField(20);
        jSeparator2 = new javax.swing.JSeparator();
        ScrollBar = new javax.swing.JScrollPane();
        DailyRecord_CompAssgn_Table = new javax.swing.JTable();
        ...
        setTitle("QCU RESERVATIONS | Daily Record - Computer Assignment");
        ...
        location.setText("Daily Record / Computer Assignment");
        ...
        Main_Panel.add(db_dr_ca_srch_bx, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 140, 280, 40));
        Main_Panel.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 200, 1070, 20));

        DailyRecord_CompAssgn_Table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "PC No.", "Name", "Time Range", "Check - in", "Check - out"
            }
        ) {
        ...
        ScrollBar.setViewportView(DailyRecord_CompAssgn_Table);
        if (DailyRecord_CompAssgn_Table.getColumnModel().getColumnCount() > 0) {
            DailyRecord_CompAssgn_Table.getColumnModel().getColumn(0).setResizable(false);
            DailyRecord_CompAssgn_Table.getColumnModel().getColumn(1).setResizable(false);
            DailyRecord_CompAssgn_Table.getColumnModel().getColumn(2).setResizable(false);
            DailyRecord_CompAssgn_Table.getColumnModel().getColumn(3).setResizable(false);
        }
        ...
        jLabel9.setForeground(new java.awt.Color(11, 42, 122));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DailyRecord_ComputerAssignment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DailyRecord_ComputerAssignment().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable DailyRecord_CompAssgn_Table;
    ...
    private javax.swing.JTextField db_dr_ca_srch_bx;
