 ...
 * @author narag
 */
public class Dashboard_ComputerAssignmentCheckOut extends javax.swing.JFrame {

    /**
     * Creates new form Dashboard_MeetingRoomReservation
     */
    public Dashboard_ComputerAssignmentCheckOut() {
        initComponents();
...
public class RoundedButton extends JButton {
    ...
    private void initComponents() {
        ...
        db_ca_chck_out_go_back = new javax.swing.JLabel();
        label_profile = new javax.swing.JLabel();
        db_ca_chck_out_student_name = new javax.swing.JLabel();
        db_ca_chck_out_student_program = new javax.swing.JLabel();
        db_ca_chck_out_student_section = new javax.swing.JLabel();
        db_ca_chck_out_student_year = new javax.swing.JLabel();
        db_ca_chck_out_contact_number = new javax.swing.JLabel();
        db_ca_chck_out_student_email = new javax.swing.JLabel();
        jLabel13 = new javax.swing.JLabel();
        db_ca_chck_out_rsrvtn_cd = new RoundedTextField(20)
        ;
        db_ca_chck_out_tm_rng = new RoundedTextField(20)
        ;
        db_ca_chck_out_trnsctn_dt = new RoundedTextField(20)
        ;
        jLabel15 = new javax.swing.JLabel();
        jLabel31 = new javax.swing.JLabel();
        db_ca_chck_out_rmrks = new RoundedTextField(20)
        ;
        db_ca_chck_out_bttn_chck_out = new RoundedButton("",30);
        jLabel32 = new javax.swing.JLabel();
        jLabel11 = new javax.swing.JLabel();
        db_ca_chck_out_chck_in_tm = new RoundedTextField(20)
        ;
        ...
        setTitle("QCU RESERVATIONS | Dashboard - Computer Assignment Check-out");
        ...
        location.setText("Dashboard / Computer Assignment Check-out");
        ...
        db_ca_chck_out_go_back.setFont(new java.awt.Font("Roboto", 1, 16)); // NOI18N
        db_ca_chck_out_go_back.setForeground(new java.awt.Color(11, 42, 122));
        db_ca_chck_out_go_back.setText("< Go Back");
        db_ca_chck_out_go_back.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        Main_Panel.add(db_ca_chck_out_go_back, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 120, -1, -1));

        label_profile.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/profile_icon.png"))); // NOI18N
        label_profile.setText("jLabel7");
        label_profile.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        Main_Panel.add(label_profile, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 160, 150, 130));

        db_ca_chck_out_student_name.setFont(new java.awt.Font("Roboto", 1, 20)); // NOI18N
        db_ca_chck_out_student_name.setText("Mabato, Ralph Christian P.");
        Main_Panel.add(db_ca_chck_out_student_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 160, -1, -1));

        db_ca_chck_out_student_program.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        db_ca_chck_out_student_program.setText("Bachelor of Science in Information Technology");
        Main_Panel.add(db_ca_chck_out_student_program, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 188, -1, -1));

        db_ca_chck_out_student_section.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        db_ca_chck_out_student_section.setText("SBIT3A");
        Main_Panel.add(db_ca_chck_out_student_section, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 210, -1, -1));

        db_ca_chck_out_student_year.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        db_ca_chck_out_student_year.setText("3rd year");
        Main_Panel.add(db_ca_chck_out_student_year, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 230, -1, -1));

        db_ca_chck_out_contact_number.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        db_ca_chck_out_contact_number.setText("09999999999");
        Main_Panel.add(db_ca_chck_out_contact_number, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 250, -1, -1));

        db_ca_chck_out_student_email.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        db_ca_chck_out_student_email.setText("mabato@gmail.com");
        Main_Panel.add(db_ca_chck_out_student_email, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 270, -1, -1));

        jLabel13.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(217, 217, 217));
        jLabel13.setText("Reservation Code");
        Main_Panel.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 320, -1, -1));

        db_ca_chck_out_rsrvtn_cd.setEditable(false);
        db_ca_chck_out_rsrvtn_cd.setBorder(null
        );
        db_ca_chck_out_rsrvtn_cd.setEnabled(false);
        Main_Panel.add(db_ca_chck_out_rsrvtn_cd, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 350, 470, 50));

        db_ca_chck_out_tm_rng.setEditable(false);
        db_ca_chck_out_tm_rng.setBorder(null
        );
        db_ca_chck_out_tm_rng.setEnabled(false);
        Main_Panel.add(db_ca_chck_out_tm_rng, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 460, 470, 50));

        db_ca_chck_out_trnsctn_dt.setEditable(false);
        db_ca_chck_out_trnsctn_dt.setBorder(null
        );
        db_ca_chck_out_trnsctn_dt.setEnabled(false);
        Main_Panel.add(db_ca_chck_out_trnsctn_dt, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 350, 470, 50));

        jLabel15.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(217, 217, 217));
        jLabel15.setText("Time range");
        Main_Panel.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 430, -1, -1));

        jLabel31.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        jLabel31.setText("Remarks");
        Main_Panel.add(jLabel31, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 540, -1, -1));

        db_ca_chck_out_rmrks.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        db_ca_chck_out_rmrks.setToolTipText("");
        db_ca_chck_out_rmrks.setBorder(null
        );
        db_ca_chck_out_rmrks.setEnabled(true);
        db_ca_chck_out_rmrks.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                db_ca_chck_out_rmrksActionPerformed(evt);
            }
        });
        Main_Panel.add(db_ca_chck_out_rmrks, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 570, 1060, 50));

        db_ca_chck_out_bttn_chck_out.setBackground(new java.awt.Color(11, 42, 122));
        db_ca_chck_out_bttn_chck_out.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        db_ca_chck_out_bttn_chck_out.setForeground(new java.awt.Color(255, 255, 255));
        db_ca_chck_out_bttn_chck_out.setText("Check Out");
        db_ca_chck_out_bttn_chck_out.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        db_ca_chck_out_bttn_chck_out.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                db_ca_chck_out_bttn_chck_outActionPerformed(evt);
            }
        });
        Main_Panel.add(db_ca_chck_out_bttn_chck_out, new org.netbeans.lib.awtextra.AbsoluteConstraints(968, 660, 150, 50));

        jLabel32.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        jLabel32.setForeground(new java.awt.Color(217, 217, 217));
        jLabel32.setText("Transaction Date");
        Main_Panel.add(jLabel32, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 320, -1, -1));

        jLabel11.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(217, 217, 217));
        jLabel11.setText("Check-In Time");
        Main_Panel.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 430, -1, -1));

        db_ca_chck_out_chck_in_tm.setEditable(false);
        db_ca_chck_out_chck_in_tm.setBorder(null
        );
        db_ca_chck_out_chck_in_tm.setEnabled(false);
        Main_Panel.add(db_ca_chck_out_chck_in_tm, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 460, 470, 50));
    ...
    private void db_ca_chck_out_rmrksActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_db_ca_chck_out_rmrksActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_db_ca_chck_out_rmrksActionPerformed

    private void db_ca_chck_out_bttn_chck_outActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_db_ca_chck_out_bttn_chck_outActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_db_ca_chck_out_bttn_chck_outActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dashboard_ComputerAssignmentCheckOut.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Dashboard_ComputerAssignmentCheckOut().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton db_ca_chck_out_bttn_chck_out;
    private javax.swing.JTextField db_ca_chck_out_chck_in_tm;
    private javax.swing.JLabel db_ca_chck_out_contact_number;
    private javax.swing.JLabel db_ca_chck_out_go_back;
    private javax.swing.JTextField db_ca_chck_out_rmrks;
    private javax.swing.JTextField db_ca_chck_out_rsrvtn_cd;
    private javax.swing.JLabel db_ca_chck_out_student_email;
    private javax.swing.JLabel db_ca_chck_out_student_name;
    private javax.swing.JLabel db_ca_chck_out_student_program;
    private javax.swing.JLabel db_ca_chck_out_student_section;
    private javax.swing.JLabel db_ca_chck_out_student_year;
    private javax.swing.JTextField db_ca_chck_out_tm_rng;
    private javax.swing.JTextField db_ca_chck_out_trnsctn_dt;
