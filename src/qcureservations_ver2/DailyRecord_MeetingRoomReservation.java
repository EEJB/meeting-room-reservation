 ...
 * @author narag
 */
public class DailyRecord_MeetingRoomReservation extends javax.swing.JFrame {

    /**
     * Creates new form Dashboard_MeetingRoomReservation
     */
    public DailyRecord_MeetingRoomReservation() {
        initComponents();
        ...
        setImageToLabel(dr_icon, "src/Image/ACTIVE DAILY RECORD.png");
        ...
        setImageToLabel(headerr_icon, "src/Image/ACTIVE DAILY RECORD.png");
        ...
        // START NEW CODE HERE
        CustomTableStyler.applyStyle(DailyRecord_MtngRmRsrvtn_Table);
    }
...
public class CustomTableStyler {
    ...
    private void initComponents() {
        ...
        db_dr_mrr_srch_bx = new RoundedTextField(20);
        jSeparator1 = new javax.swing.JSeparator();
        jSeparator2 = new javax.swing.JSeparator();
        ScrollBar = new javax.swing.JScrollPane();
        DailyRecord_MtngRmRsrvtn_Table = new javax.swing.JTable();
        ...
        setTitle("QCU RESERVATIONS | Daily Record - Meeting Room Reservation");
        ...
        dr_indicator.setBackground(new java.awt.Color(11, 42, 122));
        ...
        dr_label.setFont(new java.awt.Font("Roboto", 1, 16)); // NOI18N
        dr_label.setForeground(new java.awt.Color(11, 42, 122));
        ...
        location.setText("Daily Record / Meeting Room Reservation ");
        ...
        Main_Panel.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 150, -1, -1));
        Main_Panel.add(db_dr_mrr_srch_bx, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 140, 280, 40));
        Main_Panel.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 190, -1, -1));
        Main_Panel.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 200, 1070, 20));

        DailyRecord_MtngRmRsrvtn_Table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "Meeting Room", "Reservation By", "Time - in", "Time - out", "Number of Attendees"
            }
        ) {
        ...
        ScrollBar.setViewportView(DailyRecord_MtngRmRsrvtn_Table);
        if (DailyRecord_MtngRmRsrvtn_Table.getColumnModel().getColumnCount() > 0) {
            DailyRecord_MtngRmRsrvtn_Table.getColumnModel().getColumn(0).setResizable(false);
            DailyRecord_MtngRmRsrvtn_Table.getColumnModel().getColumn(1).setResizable(false);
            DailyRecord_MtngRmRsrvtn_Table.getColumnModel().getColumn(2).setResizable(false);
            DailyRecord_MtngRmRsrvtn_Table.getColumnModel().getColumn(3).setResizable(false);
            DailyRecord_MtngRmRsrvtn_Table.getColumnModel().getColumn(4).setResizable(false);
        }

        Main_Panel.add(ScrollBar, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 230, 1070, -1));
        ...
        jLabel7.setText("Meeting Room Reservation");
        ...
        jLabel9.setText("Computer Assignments");
        ...
        Main_Panel.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 140, -1, -1));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(0, 0, 0)
                .addComponent(Menu_Panel, javax.swing.GroupLayout.PREFERRED_SIZE, 371, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
                .addComponent(Main_Panel, javax.swing.GroupLayout.PREFERRED_SIZE, 1238, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void dailyRecord_PanelMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dailyRecord_PanelMouseExited
        ...
        dr_label.setForeground(new Color(11,42,122));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DailyRecord_MeetingRoomReservation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DailyRecord_MeetingRoomReservation().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable DailyRecord_MtngRmRsrvtn_Table;
    ...
    private javax.swing.JTextField db_dr_mrr_srch_bx;
