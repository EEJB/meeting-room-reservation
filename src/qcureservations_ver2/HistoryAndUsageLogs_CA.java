 ...
 * @author narag
 */
public class HistoryAndUsageLogs_CA extends javax.swing.JFrame {

    /**
     * Creates new form Dashboard_MeetingRoomReservation
     */
    public HistoryAndUsageLogs_CA() {
        initComponents();
        loadDeviceReservationTable();
        ...
        setImageToLabel(headerr_icon, "src/Image/ACTIVE HISTORY.png");
        ...
        CustomTableStyler.applyStyle(HUL_CA_Table);
        ...
        for (int i = 0; i < HUL_CA_Table.getColumnCount(); i++) {
            HUL_CA_Table.getColumnModel().getColumn(i).setCellRenderer(cellRenderer);
        }
...
public class RoundedButton extends JButton {
    ...
    private void initComponents() {
        ...
        HUL_CA_MRR = new javax.swing.JLabel();
        jPanel3 = new javax.swing.JPanel();
        jPanel4 = new RoundedPanel(10);
        HUL_CA_CA = new javax.swing.JLabel();
        jPanel5 = new javax.swing.JPanel();
        jPanel6 = new RoundedPanel(10);
        HUL_CA_SR = new javax.swing.JLabel();
        jSeparator2 = new javax.swing.JSeparator();
        jLabel1 = new javax.swing.JLabel();
        jLabel13 = new javax.swing.JLabel();
        HUL_CA_search = new RoundedTextField(20);
        ScrollBar = new javax.swing.JScrollPane();
        HUL_CA_Table = new javax.swing.JTable();
        HUL_CA_bttn_dwnld = new RoundedButton("",30);
        ...
        setTitle("QCU RESERVATIONS | History & Usage Logs - Computer Assignment");
        ...
        location.setText("History and Usage Logs / Computer Assignment");
        ...
        HUL_CA_MRR.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        HUL_CA_MRR.setText("Meeting Room Reservation");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(HUL_CA_MRR, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel4.setBackground(new java.awt.Color(11, 42, 122));
        ...
        HUL_CA_CA.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        HUL_CA_CA.setForeground(new java.awt.Color(11, 42, 122));
        HUL_CA_CA.setText("Computer Assignments");
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(HUL_CA_CA, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        HUL_CA_SR.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        HUL_CA_SR.setText("Saved Reports");
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(HUL_CA_SR, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        HUL_CA_search.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        HUL_CA_search.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                HUL_CA_searchKeyReleased(evt);
            }
        });
        Main_Panel.add(HUL_CA_search, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 250, 580, 50));

        HUL_CA_Table.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        HUL_CA_Table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "Device Number", "Name", "Check - In", "Check - Out", "Date", "Time Range"
            }
        ) {
        ...
        HUL_CA_Table.getTableHeader().setReorderingAllowed(false);
        ScrollBar.setViewportView(HUL_CA_Table);
        if (HUL_CA_Table.getColumnModel().getColumnCount() > 0) {
            HUL_CA_Table.getColumnModel().getColumn(0).setResizable(false);
            HUL_CA_Table.getColumnModel().getColumn(1).setResizable(false);
            HUL_CA_Table.getColumnModel().getColumn(2).setResizable(false);
            HUL_CA_Table.getColumnModel().getColumn(3).setResizable(false);
            HUL_CA_Table.getColumnModel().getColumn(4).setResizable(false);
            HUL_CA_Table.getColumnModel().getColumn(5).setResizable(false);
        }

        Main_Panel.add(ScrollBar, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 330, 1070, 310));

        HUL_CA_bttn_dwnld.setBackground(new java.awt.Color(11, 42, 122));
        HUL_CA_bttn_dwnld.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        HUL_CA_bttn_dwnld.setForeground(new java.awt.Color(255, 255, 255));
        HUL_CA_bttn_dwnld.setText("Download");
        HUL_CA_bttn_dwnld.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        HUL_CA_bttn_dwnld.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                HUL_CA_bttn_dwnldActionPerformed(evt);
            }
        });
        Main_Panel.add(HUL_CA_bttn_dwnld, new org.netbeans.lib.awtextra.AbsoluteConstraints(968, 660, 150, 50));
    ...
    private void HUL_CA_bttn_dwnldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HUL_CA_bttn_dwnldActionPerformed
        try {
            int selectedMonth = monthP.getMonth(); // 0-based
            ...
            String fileName = monthName + selectedYear + "_ComputerUsage.pdf";
            ...
            // Metadata
            pdf.getDocumentInfo().setTitle("Computer Usage Report");
            pdf.getDocumentInfo().setAuthor("Quezon City University");

            // Title
            Paragraph title = new Paragraph("Quezon City University Computer Usage Report")
            ...
            // Table
            int cols = HUL_CA_Table.getColumnCount();
            Table table = new Table(UnitValue.createPercentArray(cols)).useAllAvailableWidth();

            for (int i = 0; i < cols; i++) {
                table.addHeaderCell(new Cell().add(new Paragraph(HUL_CA_Table.getColumnName(i)).setBold()));
            }

            int rows = HUL_CA_Table.getRowCount();
            for (int row = 0; row < rows; row++) {
                for (int col = 0; col < cols; col++) {
                    Object val = HUL_CA_Table.getValueAt(row, col);
            ...
            // ✅ Insert record into DownloadedReports
            try (Connection conn = getConnection();
                 PreparedStatement stmt = conn.prepareStatement(
                         "INSERT INTO DownloadedReports (FileName, Category, DownloadDate, FilePath) VALUES (?, ?, GETDATE(), ?)")) {

                stmt.setString(1, fileToSave.getName());
                stmt.setString(2, "ComputerUsage");
    ...
    }//GEN-LAST:event_HUL_CA_bttn_dwnldActionPerformed

    private void HUL_CA_searchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_HUL_CA_searchKeyReleased
        applyDeviceFilter();
    }//GEN-LAST:event_HUL_CA_searchKeyReleased

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        monthP.setMonth(0);
        yearP.setYear(Calendar.getInstance().get(Calendar.YEAR));
        HUL_CA_search.setText("");
        loadDeviceReservationTable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HistoryAndUsageLogs_CA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HistoryAndUsageLogs_CA().setVisible(true);
            }
        });
    }
    
    public void loadDeviceReservationTable() {
        Connection conn = dbConnection.dbCon.getConnection();
        DefaultTableModel model = (DefaultTableModel) HUL_CA_Table.getModel();
        model.setRowCount(0); // clear table

        String query = "SELECT dr.assignedPC AS DeviceNumber, " +
                       "CONCAT(s.LastName, ', ', s.FirstName, ' ', s.MiddleName, ' ', ISNULL(s.Suffix, '')) AS Name, " +
                       "dr.StartTime AS CheckIn, dr.EndTime AS CheckOut, dr.TransactionDate AS Date, dr.TimeRange " +
                       "FROM DESKTOP_RESERVATION dr " +
                       "JOIN STUDENT s ON dr.StudentID = s.studentID " +
                       "JOIN DESKTOP d ON dr.DesktopID = d.DesktopID";

        try (PreparedStatement ps = conn.prepareStatement(query);
             ResultSet rs = ps.executeQuery()) {

            while (rs.next()) {
                String deviceNum = rs.getString("DeviceNumber");
                String name = rs.getString("Name");
                Time checkIn = rs.getTime("CheckIn");
                Time checkOut = rs.getTime("CheckOut");
                Date date = rs.getDate("Date");
                String range = rs.getString("TimeRange");

                model.addRow(new Object[]{deviceNum, name, checkIn, checkOut, date, range});
            }
    ...
    public void filterDeviceReservations(Integer selectedMonth, Integer selectedYear, String searchTerm) {
        Connection conn = dbConnection.dbCon.getConnection();
        DefaultTableModel model = (DefaultTableModel) HUL_CA_Table.getModel();
        model.setRowCount(0); // clear table
        ...
        StringBuilder query = new StringBuilder("""
            SELECT 
                dr.assignedPC AS DeviceNumber,
                CONCAT(s.LastName, ', ', s.FirstName, ' ', s.MiddleName, ' ', ISNULL(s.Suffix, '')) AS Name,
                dr.StartTime AS CheckIn,
                dr.EndTime AS CheckOut,
                dr.TransactionDate AS Date,
                dr.TimeRange
            FROM DESKTOP_RESERVATION dr
            JOIN STUDENT s ON dr.StudentID = s.studentID
            JOIN DESKTOP d ON dr.DesktopID = d.DesktopID
        ...
        // Apply month and year filter if selected
        if (selectedMonth != null && selectedYear != null) {
            query.append(" AND YEAR(dr.TransactionDate) = ?");
            parameters.add(selectedYear);
            query.append(" AND MONTH(dr.TransactionDate) = ?");
            parameters.add(selectedMonth);
        }
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            query.append("""
                AND (
                    ...
                    OR FORMAT(dr.StartTime, 'hh\\:mm') LIKE ?
                    OR FORMAT(dr.EndTime, 'hh\\:mm') LIKE ?
                    OR dr.TimeRange LIKE ?
                )
            """);
            ...
            parameters.add(term); // DeviceNumber
            parameters.add(term); // CheckIn time
            parameters.add(term); // CheckOut time
            parameters.add(term); // TimeRange
        }
    ...
    private void applyDeviceFilter() {
        // Get the selected month and year from the month and year choosers
        Integer selectedMonth = monthP.getMonth() + 1; // JMonthChooser returns 0-based month, adjust to 1-based
        Integer selectedYear = yearP.getYear();

        // Get the search term from the text field
        String keyword = HUL_CA_search.getText().trim();

        // Call the filter method with the selected month, year, and search term
        filterDeviceReservations(selectedMonth, selectedYear, keyword);
    }
    
    private void openHistoryAndUsageLogsMR() {
        // Assuming HistoryAndUsageLogs_CA is a JFrame
        HistoryAndUsageLogs_MR historyFrame = new HistoryAndUsageLogs_MR();
    ...
    private javax.swing.JLabel HUL_CA_CA;
    private javax.swing.JLabel HUL_CA_MRR;
    private javax.swing.JLabel HUL_CA_SR;
    private javax.swing.JTable HUL_CA_Table;
    private javax.swing.JButton HUL_CA_bttn_dwnld;
    private javax.swing.JTextField HUL_CA_search;
