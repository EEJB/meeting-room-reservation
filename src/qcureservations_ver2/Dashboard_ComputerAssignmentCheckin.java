 ...
 * @author narag
 */
public class Dashboard_ComputerAssignmentCheckin extends javax.swing.JFrame {

    /**
     * Creates new form Dashboard_MeetingRoomReservation
     */
    public Dashboard_ComputerAssignmentCheckin() {
        initComponents();
...
public class RoundedButton extends JButton {
    ...
    private void initComponents() {
        ...
        db_ca_chck_in_go_back = new javax.swing.JLabel();
        db_ca_chck_in_profile = new javax.swing.JLabel();
        db_ca_chck_in_student_name = new javax.swing.JLabel();
        db_ca_chck_in_student_program = new javax.swing.JLabel();
        db_ca_chck_in_student_section = new javax.swing.JLabel();
        db_ca_chck_in_student_year = new javax.swing.JLabel();
        db_ca_chck_in_contact_number = new javax.swing.JLabel();
        db_ca_chck_in_student_email = new javax.swing.JLabel();
        jLabel13 = new javax.swing.JLabel();
        jLabel15 = new javax.swing.JLabel();
        db_ca_chck_in_trnsctn_dt = new RoundedTextField(20)
        ;
        db_ca_chck_in_chckin_tm = new RoundedTextField(20)
        ;
        jLabel11 = new javax.swing.JLabel();
        db_ca_chck_in_rsrvtn_cd = new RoundedTextField(20)
        ;
        jLabel23 = new javax.swing.JLabel();
        jLabel31 = new javax.swing.JLabel();
        db_ca_chck_in_purpose = new RoundedTextField(20)
        ;
        db_ca_chck_in_bttn_assign = new RoundedButton("",30);
        db_ca_chck_in_time_range = new javax.swing.JComboBox<>();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("QCU RESERVATIONS | Dashboard - Computer Assignment Check-in");
        ...
        location.setText("Dashboard / Computer Assignment Check-in");
        ...
        db_ca_chck_in_go_back.setFont(new java.awt.Font("Roboto", 1, 16)); // NOI18N
        db_ca_chck_in_go_back.setForeground(new java.awt.Color(11, 42, 122));
        db_ca_chck_in_go_back.setText("< Go Back");
        db_ca_chck_in_go_back.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        Main_Panel.add(db_ca_chck_in_go_back, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 120, -1, -1));

        db_ca_chck_in_profile.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/profile_icon.png"))); // NOI18N
        db_ca_chck_in_profile.setText("jLabel7");
        db_ca_chck_in_profile.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        Main_Panel.add(db_ca_chck_in_profile, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 160, 150, 130));

        db_ca_chck_in_student_name.setFont(new java.awt.Font("Roboto", 1, 20)); // NOI18N
        db_ca_chck_in_student_name.setText("Mabato, Ralph Christian P.");
        Main_Panel.add(db_ca_chck_in_student_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 160, -1, -1));

        db_ca_chck_in_student_program.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        db_ca_chck_in_student_program.setText("Bachelor of Science in Information Technology");
        Main_Panel.add(db_ca_chck_in_student_program, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 188, -1, -1));

        db_ca_chck_in_student_section.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        db_ca_chck_in_student_section.setText("SBIT3A");
        Main_Panel.add(db_ca_chck_in_student_section, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 210, -1, -1));

        db_ca_chck_in_student_year.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        db_ca_chck_in_student_year.setText("3rd year");
        Main_Panel.add(db_ca_chck_in_student_year, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 230, -1, -1));

        db_ca_chck_in_contact_number.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        db_ca_chck_in_contact_number.setText("09999999999");
        Main_Panel.add(db_ca_chck_in_contact_number, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 250, -1, -1));

        db_ca_chck_in_student_email.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        db_ca_chck_in_student_email.setText("mabato@gmail.com");
        Main_Panel.add(db_ca_chck_in_student_email, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 270, -1, -1));
        ...
        jLabel15.setText("Transaction Date");
        Main_Panel.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 320, -1, -1));

        db_ca_chck_in_trnsctn_dt.setEditable(false);
        db_ca_chck_in_trnsctn_dt.setBorder(null
        );
        db_ca_chck_in_trnsctn_dt.setEnabled(false);
        Main_Panel.add(db_ca_chck_in_trnsctn_dt, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 350, 470, 50));

        db_ca_chck_in_chckin_tm.setEditable(false);
        db_ca_chck_in_chckin_tm.setBorder(null
        );
        db_ca_chck_in_chckin_tm.setEnabled(false);
        Main_Panel.add(db_ca_chck_in_chckin_tm, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 460, 470, 50));
        ...
        db_ca_chck_in_rsrvtn_cd.setEditable(false);
        db_ca_chck_in_rsrvtn_cd.setBorder(null
        );
        db_ca_chck_in_rsrvtn_cd.setEnabled(false);
        Main_Panel.add(db_ca_chck_in_rsrvtn_cd, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 350, 470, 50));

        jLabel23.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        jLabel23.setText("Time Range");
        Main_Panel.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 430, -1, -1));
        ...
        db_ca_chck_in_purpose.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        db_ca_chck_in_purpose.setToolTipText("");
        db_ca_chck_in_purpose.setBorder(null
        );
        db_ca_chck_in_purpose.setEnabled(true);
        db_ca_chck_in_purpose.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                db_ca_chck_in_purposeActionPerformed(evt);
            }
        });
        Main_Panel.add(db_ca_chck_in_purpose, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 570, 1060, 50));

        db_ca_chck_in_bttn_assign.setBackground(new java.awt.Color(11, 42, 122));
        db_ca_chck_in_bttn_assign.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        db_ca_chck_in_bttn_assign.setForeground(new java.awt.Color(255, 255, 255));
        db_ca_chck_in_bttn_assign.setText("Assign");
        db_ca_chck_in_bttn_assign.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        Main_Panel.add(db_ca_chck_in_bttn_assign, new org.netbeans.lib.awtextra.AbsoluteConstraints(968, 660, 150, 50));

        db_ca_chck_in_time_range.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        db_ca_chck_in_time_range.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1-2 Hours", "3-4 Hours", "5-6 Hours", " " }));
        Main_Panel.add(db_ca_chck_in_time_range, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 460, 470, 50));
    ...
    private void db_ca_chck_in_purposeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_db_ca_chck_in_purposeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_db_ca_chck_in_purposeActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dashboard_ComputerAssignmentCheckin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Dashboard_ComputerAssignmentCheckin().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton db_ca_chck_in_bttn_assign;
    private javax.swing.JTextField db_ca_chck_in_chckin_tm;
    private javax.swing.JLabel db_ca_chck_in_contact_number;
    private javax.swing.JLabel db_ca_chck_in_go_back;
    private javax.swing.JLabel db_ca_chck_in_profile;
    private javax.swing.JTextField db_ca_chck_in_purpose;
    private javax.swing.JTextField db_ca_chck_in_rsrvtn_cd;
    private javax.swing.JLabel db_ca_chck_in_student_email;
    private javax.swing.JLabel db_ca_chck_in_student_name;
    private javax.swing.JLabel db_ca_chck_in_student_program;
    private javax.swing.JLabel db_ca_chck_in_student_section;
    private javax.swing.JLabel db_ca_chck_in_student_year;
    private javax.swing.JComboBox<String> db_ca_chck_in_time_range;
    private javax.swing.JTextField db_ca_chck_in_trnsctn_dt;
