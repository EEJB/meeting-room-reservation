...
import PopUp.AddComputer;
import PopUp.AddDeviceQuestion;
import PopUp.GlassPaneOverlay;
import PopUp.SaveChanges_Device;
import PopUp.SuccessAdd_Device;
import PopUp.SuccessSaveChanges_Device;
 ...
 * @author narag
 */
public class ComputerManagement extends javax.swing.JFrame {
    ...
    public ComputerManagement() {
        ...
        setImageToLabel(cm_icon, "src/Image/ACTIVE COMPUTER MANAGEMENT.png");
        ...
        setImageToLabel(headerr_icon, "src/Image/ACTIVE COMPUTER MANAGEMENT.png");
        
        // START NEW CODE HERE
        
        CustomTableStyler.applyStyle(CM_table);
        
        Vector<String> columnNames = new Vector<>();
        columnNames.add("PC Number");
        columnNames.add("Availability");
        columnNames.add("Condition");

        DefaultTableModel model = (DefaultTableModel) CM_table.getModel();

        DefaultTableModel editableModel = new DefaultTableModel(
            model.getDataVector(), columnNames
        ) {
            @Override
            public boolean isCellEditable(int row, int column) {
                return isEditMode && (column == 1 || column == 2); // Allow only Availability and Condition
            }
        };

        CM_table.setModel(editableModel);
        ...
        for (int i = 0; i < CM_table.getColumnCount(); i++) {
            CM_table.getColumnModel().getColumn(i).setCellRenderer(cellRenderer);
        }
    }
...
public class RoundedTextField extends JTextField {
    ...
    private void initComponents() {
        ...
        CM_table = new javax.swing.JTable();
        CM_srch_bx = new RoundedTextField(20);
        jLabel1 = new javax.swing.JLabel();
        CM_bttn_update = new RoundedButton("",30);
        CM_bttn_add_device = new RoundedButton("",30);

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("QCU RESERVATIONS | Computer Management");
        ...
        cm_indicator.setBackground(new java.awt.Color(11, 42, 122));
        ...
        cm_label.setFont(new java.awt.Font("Roboto", 1, 16)); // NOI18N
        cm_label.setForeground(new java.awt.Color(11, 42, 122));
        ...
        CM_table.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        CM_table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
            ...
            new String [] {
                "PC Number", "Availability", "Condition"
            }
        ) {
        ...
        CM_table.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(CM_table);
        if (CM_table.getColumnModel().getColumnCount() > 0) {
            CM_table.getColumnModel().getColumn(0).setResizable(false);
            CM_table.getColumnModel().getColumn(1).setResizable(false);
            CM_table.getColumnModel().getColumn(2).setResizable(false);
        }

        Main_Panel.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 190, 1070, 430));

        CM_srch_bx.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                CM_srch_bxKeyReleased(evt);
            }
        });
        Main_Panel.add(CM_srch_bx, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 120, 1000, 40));

        jLabel1.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        jLabel1.setText("Search:");
        Main_Panel.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 130, -1, -1));

        CM_bttn_update.setBackground(new java.awt.Color(11, 42, 122));
        CM_bttn_update.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        CM_bttn_update.setForeground(new java.awt.Color(255, 255, 255));
        CM_bttn_update.setText("Update");
        CM_bttn_update.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        CM_bttn_update.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CM_bttn_updateActionPerformed(evt);
            }
        });
        Main_Panel.add(CM_bttn_update, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 650, 150, 50));

        CM_bttn_add_device.setBackground(new java.awt.Color(219, 229, 255));
        CM_bttn_add_device.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        CM_bttn_add_device.setText("Add Device");
        CM_bttn_add_device.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        CM_bttn_add_device.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CM_bttn_add_deviceActionPerformed(evt);
            }
        });
        Main_Panel.add(CM_bttn_add_device, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 650, 150, 50));
    ...
    private void CM_PanelMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CM_PanelMouseExited
        ...
        cm_label.setForeground(new Color(11,42,122));
    }//GEN-LAST:event_CM_PanelMouseExited

    private void CM_bttn_add_deviceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CM_bttn_add_deviceActionPerformed
        // Open the Add Desktop Popup
        AddComputer addDesktopPopup = new AddComputer(); // your custom popup panel
        GlassPaneOverlay glassPaneOverlay = new GlassPaneOverlay(addDesktopPopup);
        setGlassPane(glassPaneOverlay);
        getGlassPane().setVisible(true);

        addDesktopPopup.setAddComputerListener(new AddComputer.AddComputerListener() {
            @Override
            public void onAdd(String pcNumber, String availability, String condition) {
                // After clicking "Add", first close the AddComputer popup
                getGlassPane().setVisible(false);

                // Now open the confirmation popup
                AddDeviceQuestion confirmPopup = new AddDeviceQuestion();
                GlassPaneOverlay confirmOverlay = new GlassPaneOverlay(confirmPopup);
                setGlassPane(confirmOverlay);
                getGlassPane().setVisible(true);

                confirmPopup.setConfirmListener(new AddDeviceQuestion.ConfirmListener() {
                    @Override
                    public void onYes() {
                        // User confirmed: save to database
                        addDesktopToDatabase(pcNumber, availability, condition);
                        getGlassPane().setVisible(false);

                        // Show success popup
                        SuccessAdd_Device successPanel = new SuccessAdd_Device();
                        GlassPaneOverlay successOverlay = new GlassPaneOverlay(successPanel);
                    ...
                    @Override
                    public void onNo() {
                        // User canceled: just close confirmation
                        getGlassPane().setVisible(false);
                    }
                });
            }
            ...
            public void onCancel() {
                // Cancel clicked inside AddComputer form
                getGlassPane().setVisible(false);
            }
        });
    }//GEN-LAST:event_CM_bttn_add_deviceActionPerformed

    private void CM_bttn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CM_bttn_updateActionPerformed
        if (!isEditMode) {
            // Enable editing mode
            isEditMode = true;
            CM_bttn_update.setText("Save");

            // Enable combo boxes for "Availability" and "Condition" columns
            ...
            TableColumn availabilityColumn = CM_table.getColumnModel().getColumn(1); // Availability is column 1
            availabilityColumn.setCellEditor(new DefaultCellEditor(availabilityComboBox));

            String[] conditionOptions = {"Good Condition", "Bad Condition"};
            JComboBox<String> conditionComboBox = new JComboBox<>(conditionOptions);
            TableColumn conditionColumn = CM_table.getColumnModel().getColumn(2); // Condition is column 2
            conditionColumn.setCellEditor(new DefaultCellEditor(conditionComboBox));

        } else {
            // Show Save Changes popup
            SaveChanges_Device saveCM = new SaveChanges_Device();
            GlassPaneOverlay glassPaneOverlay = new GlassPaneOverlay(saveCM);
            setGlassPane(glassPaneOverlay);
            getGlassPane().setVisible(true);

            // Listen for Yes/No from the popup
            saveCM.setConfirmListener(new SaveChanges_Device.ConfirmListener() {
                @Override
                public void onYes() {
                    saveDesktopChanges(); // Your method to save changes to database
                    isEditMode = false;
                    CM_bttn_update.setText("Update");
                    getGlassPane().setVisible(false);

                    // Show Success popup
                    SuccessSaveChanges_Device successPanel = new SuccessSaveChanges_Device();
                    GlassPaneOverlay successOverlay = new GlassPaneOverlay(successPanel);
                    setGlassPane(successOverlay);
                    getGlassPane().setVisible(true);
                }
...
//            CM_bttn_update.setText("Save");
//
//            makeTableEditableWithDropdowns(); 
//
//            // Set custom renderers to instantly show combobox-like look
//            String[] availabilityOptions = {"Available", "Unavailable"};
//            String[] conditionOptions = {"Good Condition", "Bad Condition"};
//
//            TableColumn availabilityColumn = CM_table.getColumnModel().getColumn(1);
//            availabilityColumn.setCellRenderer(new ComboBoxRenderer(availabilityOptions));
//
//            TableColumn conditionColumn = CM_table.getColumnModel().getColumn(2);
//            conditionColumn.setCellRenderer(new ComboBoxRenderer(conditionOptions));
//
//        } else {
//            // Save confirmation popup
//            SaveChanges_Device SaveDesktop = new SaveChanges_Device();
//            GlassPaneOverlay glassPaneOverlay = new GlassPaneOverlay(SaveDesktop);
//            setGlassPane(glassPaneOverlay);
//            getGlassPane().setVisible(true);
//
//            SaveDesktop.setConfirmListener(new SaveChanges_Device.ConfirmListener() {
//                @Override
//                public void onYes() {
//                    saveDesktopChanges();
//                    isEditMode = false;
...
//                    getGlassPane().setVisible(false);
//
//                    // Reset normal renderers
//                    resetTableRenderers();
//
//                    // success popup
//                    SuccessSaveChanges_Device successPanel = new SuccessSaveChanges_Device();
//                    GlassPaneOverlay glassOverlay = new GlassPaneOverlay(successPanel);
...
//            });
//        }
    }//GEN-LAST:event_CM_bttn_updateActionPerformed

    private void CM_srch_bxKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CM_srch_bxKeyReleased
        applyDesktopFilter();
    }//GEN-LAST:event_CM_srch_bxKeyReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ComputerManagement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ComputerManagement().setVisible(true);
            }
        });
    }
    
    public void loadDesktopTable() {
        Connection conn = dbConnection.dbCon.getConnection(); // your dbCon class
        DefaultTableModel model = (DefaultTableModel) CM_table.getModel(); // Replace with your JTable variable
        model.setRowCount(0); // Clear existing rows

        String query = "SELECT PCNumber, Status, CONDITION FROM DESKTOP";
        ...
        try (PreparedStatement ps = conn.prepareStatement(query);
            ...
            while (rs.next()) {
                ...
                model.addRow(new Object[]{pcNumber, availability, condition});
            }
    ...
    public void filterDesktop(String searchTerm) {
        Connection conn = dbConnection.dbCon.getConnection();
        DefaultTableModel model = (DefaultTableModel) CM_table.getModel(); // your JTable
        model.setRowCount(0); // Clear existing rows

        String query = """
            SELECT PCNumber, Status, CONDITION
            FROM DESKTOP
            WHERE PCNumber LIKE ? OR Status LIKE ? OR CONDITION LIKE ?
        """;
    ...
    private void applyDesktopFilter() {
        String keyword = CM_srch_bx.getText().trim(); // your search textbox for desktop
        filterDesktop(keyword);
    }
    
    private void saveDesktopTableChanges() {
        Connection conn = dbConnection.dbCon.getConnection();

        for (int i = 0; i < CM_table.getRowCount(); i++) {
            String pcNumber = (String) CM_table.getValueAt(i, 0);
            String availability = (String) CM_table.getValueAt(i, 1);
            String condition = (String) CM_table.getValueAt(i, 2);

            String updateQuery = "UPDATE DESKTOP SET Status = ?, CONDITION = ? WHERE PCNumber = ?";

            try (PreparedStatement ps = conn.prepareStatement(updateQuery)) {
                ps.setString(1, availability);
                ps.setString(2, condition);
                ps.setString(3, pcNumber);
                ps.executeUpdate();
            } catch (SQLException e) {
                e.printStackTrace();
            }
        ...
        // Optional: reload table after saving
        loadDesktopTable();
    }
    
    private void saveDesktopChanges() {
        DefaultTableModel model = (DefaultTableModel) CM_table.getModel(); // your table
        Connection conn = dbConnection.dbCon.getConnection(); // your connection class

        try {
            for (int i = 0; i < model.getRowCount(); i++) {
                String pcNumber = model.getValueAt(i, 0).toString(); // PC Number
                String availability = model.getValueAt(i, 1).toString(); // Availability
                String condition = model.getValueAt(i, 2).toString(); // Condition
            ...
            loadDesktopTable(); // after saving, reload updated data

        } catch (SQLException ex) {
            ex.printStackTrace();
            JOptionPane.showMessageDialog(this, "Error updating desktop information: " + ex.getMessage());
        }
    }
    
    private void addDesktopToDatabase(String pcNumber, String availability, String condition) {
        Connection conn = dbConnection.dbCon.getConnection();
        String insertQuery = "INSERT INTO DESKTOP (PCNumber, Status, CONDITION) VALUES (?, ?, ?)";

        try (PreparedStatement ps = conn.prepareStatement(insertQuery)) {
            ps.setString(1, pcNumber);
            ps.setString(2, availability);
            ps.setString(3, condition);
            ps.executeUpdate();
            loadDesktopTable(); // reload table to see new entry
        } catch (SQLException e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Error adding desktop: " + e.getMessage());
        }
    }
    
    

//    private void makeTableEditableWithDropdowns() {
//        String[] availabilityOptions = {"Available", "Unavailable"};
//        String[] conditionOptions = {"Good Condition", "Bad Condition"};
//
//        TableColumn availabilityColumn = CM_table.getColumnModel().getColumn(1);
...
//        conditionColumn.setCellEditor(new DefaultCellEditor(conditionComboBox));
//
//        // Set renderer (important part!)
//        availabilityColumn.setCellRenderer(new DefaultTableCellRenderer() {
//            @Override
//            public Component getTableCellRendererComponent(JTable table, Object value,
//                                                           boolean isSelected, boolean hasFocus,
//                                                           int row, int column) {
//                JComboBox<String> comboBox = new JComboBox<>(availabilityOptions);
...
//        });
//
//        conditionColumn.setCellRenderer(new DefaultTableCellRenderer() {
//            @Override
//            public Component getTableCellRendererComponent(JTable table, Object value,
//                                                           boolean isSelected, boolean hasFocus,
//                                                           int row, int column) {
//                JComboBox<String> comboBox = new JComboBox<>(conditionOptions);
//                comboBox.setSelectedItem(value);
//                if (isSelected) {
//                    comboBox.setBackground(table.getSelectionBackground());
//                } else {
...
//    }    
//
//    private void resetTableRenderers() {
//        // Reset to default renderers (no combobox after saving)
//        TableColumn availabilityColumn = CM_table.getColumnModel().getColumn(1);
//        TableColumn conditionColumn = CM_table.getColumnModel().getColumn(2);
//
//        availabilityColumn.setCellRenderer(new DefaultTableCellRenderer());
...
//    }
    ...
    private javax.swing.JButton CM_bttn_add_device;
    private javax.swing.JButton CM_bttn_update;
    private javax.swing.JTextField CM_srch_bx;
    private javax.swing.JTable CM_table;
