 ...
 * @author narag
 */
public class HistoryAndUsageLogs_SavedReports extends javax.swing.JFrame {

    /**
     * Creates new form Dashboard_MeetingRoomReservation
     */
    public HistoryAndUsageLogs_SavedReports() {
        initComponents();
        loadSavedReports();
...
public class RoundedPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        HUL_SR_MRR = new javax.swing.JLabel();
        jPanel3 = new javax.swing.JPanel();
        jPanel4 = new RoundedPanel(10);
        HUL_SR_CA = new javax.swing.JLabel();
        jPanel5 = new javax.swing.JPanel();
        jPanel6 = new RoundedPanel(10);
        HUL_SR_SR = new javax.swing.JLabel();
        jSeparator2 = new javax.swing.JSeparator();
        jLabel1 = new javax.swing.JLabel();
        HUL_SR_search = new RoundedTextField(20);
        jLabel13 = new javax.swing.JLabel();
        HUL_SR_bttn_open = new RoundedButton("",30);
        ScrollBar = new javax.swing.JScrollPane();
        HUL_SR_list = new javax.swing.JList<>();
        monthP = new com.toedter.calendar.JMonthChooser();
        yearP = new com.toedter.calendar.JYearChooser();
        jLabel7 = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("QCU RESERVATIONS | History & Usage Logs - Saved Reports");
        ...
        Main_Panel.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(248, 247, 253)));
        ...
        location.setText("History and Usage Logs / Saved Reports");
        ...
        HUL_SR_MRR.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        HUL_SR_MRR.setText("Meeting Room Reservation");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(HUL_SR_MRR, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        HUL_SR_CA.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        HUL_SR_CA.setText("Computer Assignments");
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(HUL_SR_CA, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel6.setBackground(new java.awt.Color(11, 42, 122));
        ...
        HUL_SR_SR.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        HUL_SR_SR.setForeground(new java.awt.Color(11, 42, 122));
        HUL_SR_SR.setText("Saved Reports");
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(HUL_SR_SR, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        HUL_SR_search.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        HUL_SR_search.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                HUL_SR_searchKeyReleased(evt);
            }
        });
        Main_Panel.add(HUL_SR_search, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 250, 710, 50));

        jLabel13.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        jLabel13.setText("Search:");
        Main_Panel.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 220, -1, -1));

        HUL_SR_bttn_open.setBackground(new java.awt.Color(11, 42, 122));
        HUL_SR_bttn_open.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        HUL_SR_bttn_open.setForeground(new java.awt.Color(255, 255, 255));
        HUL_SR_bttn_open.setText("Open");
        HUL_SR_bttn_open.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        HUL_SR_bttn_open.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                HUL_SR_bttn_openActionPerformed(evt);
            }
        });
        Main_Panel.add(HUL_SR_bttn_open, new org.netbeans.lib.awtextra.AbsoluteConstraints(968, 660, 150, 50));

        HUL_SR_list.setBackground(new java.awt.Color(248, 247, 253));
        HUL_SR_list.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        ScrollBar.setViewportView(HUL_SR_list);

        Main_Panel.add(ScrollBar, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 330, 1060, 300));
    ...
    private void HUL_SR_bttn_openActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HUL_SR_bttn_openActionPerformed
        // Get the selected file name from the JList
        String selectedFile = HUL_SR_list.getSelectedValue();

        if (selectedFile != null) {
            try {
                // Query the database to get the full file path using the selected file name
                String sql = "SELECT FilePath FROM DownloadedReports WHERE FileName = ?";
                try (Connection conn = dbConnection.dbCon.getConnection();
                     PreparedStatement stmt = conn.prepareStatement(sql)) {

                    stmt.setString(1, selectedFile);  // Set the file name to match
                    ...
                    if (rs.next()) {
                        ...
                        if (fileToOpen.exists()) {
                            // Open the file using the default system application (e.g., PDF viewer)
                            Desktop.getDesktop().open(fileToOpen);
                        } else {
                            JOptionPane.showMessageDialog(this, "The file no longer exists.");
                        }
                    } else {
                        JOptionPane.showMessageDialog(this, "File not found in database.");
                    }
                }
            ...
            JOptionPane.showMessageDialog(this, "Please select a report to open.");
        }
    }//GEN-LAST:event_HUL_SR_bttn_openActionPerformed
    ...
    private void HUL_SR_searchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_HUL_SR_searchKeyReleased
        applyReportFilter();
    }//GEN-LAST:event_HUL_SR_searchKeyReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HistoryAndUsageLogs_SavedReports.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HistoryAndUsageLogs_SavedReports().setVisible(true);
            }
        });
    }
    ...
    private void openHistoryAndUsageLogsCA() {
        // Assuming HistoryAndUsageLogs_CA is a JFrame
    ...
    private void loadSavedReports() {
        ...
        String query = "SELECT ID, FileName, FilePath FROM DownloadedReports WHERE Category IN ('MeetingRoom', 'ComputerUsage') ORDER BY DownloadDate DESC";
...
//                else {
//                    // Optional: Clean up the database if file is missing
//                    deleteMissingFileRecord(id);
//                }
            }

        } catch (Exception e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Failed to load saved reports: " + e.getMessage());
        }

        HUL_SR_list.setModel(listModel); // Show in your JList
    }

    // Helper method to delete missing file records from the database
    private void deleteMissingFileRecord(int id) {
        String deleteQuery = "DELETE FROM DownloadedReports WHERE ID = ?";
    ...
    public void filterDownloadedReports(int month, int year, String searchTerm) {
        Connection conn = dbConnection.dbCon.getConnection();
        DefaultListModel<String> listModel = new DefaultListModel<>();

        StringBuilder query = new StringBuilder("""
            SELECT FileName 
            FROM DownloadedReports 
            WHERE 1=1
        """);

        List<Object> parameters = new ArrayList<>();

        // Add filtering for month and year
        if (month > 0 && year > 0) {
            query.append(" AND MONTH(DownloadDate) = ? AND YEAR(DownloadDate) = ?");
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            query.append(" AND FileName LIKE ?");
            parameters.add("%" + searchTerm.trim() + "%");
        }

        query.append(" ORDER BY DownloadDate DESC");
        ...
        try (PreparedStatement ps = conn.prepareStatement(query.toString())) {
            ...
            while (rs.next()) {
                listModel.addElement(rs.getString("FileName"));
            }

            HUL_SR_list.setModel(listModel); // Update JList
    ...
    private void applyReportFilter() {
        int selectedMonth = monthP.getMonth() + 1; // JMonthChooser is 0-based
        int selectedYear = yearP.getYear();        // JYearChooser returns full year
        String search = HUL_SR_search.getText().trim(); // JTextField for search

        filterDownloadedReports(selectedMonth, selectedYear, search);
    }
    ...
    private javax.swing.JLabel HUL_SR_CA;
    private javax.swing.JLabel HUL_SR_MRR;
    private javax.swing.JLabel HUL_SR_SR;
    private javax.swing.JButton HUL_SR_bttn_open;
    private javax.swing.JList<String> HUL_SR_list;
    private javax.swing.JTextField HUL_SR_search;
